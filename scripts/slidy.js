...
// and also the help text which is longer
  ...
  strings_es: {
    ...
    "Table of Contents":"Tabla de Contenidos",
    "restart presentation":"Reiniciar presentaciÃ³n",
    "restart?":"Inicio"
  },
  help_es:
    "Utilice el ratÃ³n, barra espaciadora, teclas Izda/Dcha, " +
    "o Re pÃ¡g y Av pÃ¡g. Use S y B para cambiar el tamaÃ±o de fuente.",
  ...
  strings_ca: {
    ...
    "Table of Contents":"Taula de Continguts",
    "restart presentation":"Reiniciar presentaciÃ³",
    "restart?":"Inici"
  },
  help_ca:
    "Utilitzi el ratolÃ­, barra espaiadora, tecles Esq./Dta. " +
    "o Re pÃ g y Av pÃ g. Usi S i B per canviar grandÃ ria de font.",
  ...
  help_cs:
    "Prezentaci mÅ¯Å¾ete prochÃ¡zet pomocÃ­ kliknutÃ­ myÅ¡i, mezernÃ­ku, " +
    "Å¡ipek vlevo a vpravo nebo klÃ¡ves PageUp a PageDown. PÃ­smo se " +
    "dÃ¡ zvÄ›tÅ¡it a zmenÅ¡it pomocÃ­ klÃ¡ves B a S.",
  ...
  strings_de: {
    ...
    "Table of Contents":"Inhaltsverzeichnis",
    "restart presentation":"PrÃ¤sentation neu starten",
    "restart?":"Neustart"
  },
  help_de:
    "Benutzen Sie die Maus, Leerschlag, die Cursortasten links/rechts oder " +
    "Page up/Page Down zum Wechseln der Seiten und S und B fÃ¼r die SchriftgrÃ¶sse.",
  ...
  help_pl:
    "Zmieniaj slajdy klikajÄ…c myszÄ…, naciskajÄ…c spacjÄ™, strzaÅ‚ki lewo/prawo" +
    "lub PgUp / PgDn. UÅ¼yj klawiszy S i B, aby zmieniÄ‡ rozmiar czczionki.",
  ...
  strings_fr: {
    ...
    "Table of Contents":"Table des matiÃ¨res",
    "restart presentation":"Recommencer l'exposÃ©",
    "restart?":"DÃ©but"
  },
  help_fr:
    "Naviguez avec la souris, la barre d'espace, les flÃ¨ches " +
  ...
  strings_hu: {
    ...
    "help?":"segÃ­tsÃ©g",
    "contents?":"tartalom",
    "table of contents":"tartalomjegyzÃ©k",
    "Table of Contents":"TartalomjegyzÃ©k",
    "restart presentation":"bemutatÃ³ ÃºjraindÃ­tÃ¡sa",
    "restart?":"ÃºjraindÃ­tÃ¡s"
  },
  help_hu:
    "Az oldalak kÃ¶zti lÃ©pkedÃ©shez kattintson az egÃ©rrel, vagy " +
    "hasznÃ¡lja a szÃ³kÃ¶z, a bal, vagy a jobb nyÃ­l, illetve a Page Down, " +
    "Page Up billentyÅ±ket. Az S Ã©s a B billentyÅ±kkel vÃ¡ltoztathatja " +
    "a szÃ¶veg mÃ©retÃ©t.",
  ...
  strings_el: {
    "slide":"ÏƒÎµÎ»Î¯Î´Î±",
    "help?":"Î²Î¿Î®Î¸ÎµÎ¹Î±;",
    "contents?":"Ï€ÎµÏ�Î¹ÎµÏ‡ÏŒÎ¼ÎµÎ½Î±;",
    "table of contents":"Ï€Î¯Î½Î±ÎºÎ±Ï‚ Ï€ÎµÏ�Î¹ÎµÏ‡Î¿Î¼Î­Î½Ï‰Î½",
    "Table of Contents":"Î Î¯Î½Î±ÎºÎ±Ï‚ Î ÎµÏ�Î¹ÎµÏ‡Î¿Î¼Î­Î½Ï‰Î½",
    "restart presentation":"ÎµÏ€Î±Î½ÎµÎºÎºÎ¯Î½Î·ÏƒÎ· Ï€Î±Ï�Î¿Ï…ÏƒÎ¯Î±ÏƒÎ·Ï‚",
    "restart?":"ÎµÏ€Î±Î½ÎµÎºÎºÎ¯Î½Î·ÏƒÎ·;"
  },
  help_el:
    "Î Î»Î¿Î·Î³Î·Î¸ÎµÎ¯Ï„Îµ Î¼Îµ Ï„Î¿ ÎºÎ»Î¯Îº Ï„Î¿Ï… Ï€Î¿Î½Ï„Î¹ÎºÎ¹Î¿Ï�, Ï„Î¿ space, Ï„Î± Î²Î­Î»Î· Î±Ï�Î¹ÏƒÏ„ÎµÏ�Î¬/Î´ÎµÎ¾Î¹Î¬, " +
    "Î® Page Up ÎºÎ±Î¹ Page Down. Î§Ï�Î·ÏƒÎ¹Î¼Î¿Ï€Î¿Î¹Î®ÏƒÏ„Îµ Ï„Î± Ï€Î»Î®ÎºÏ„Ï�Î± S ÎºÎ±Î¹ B Î³Î¹Î± Î½Î± Î±Î»Î»Î¬Î¾ÎµÏ„Îµ " +
    "Ï„Î¿ Î¼Î­Î³ÎµÎ¸Î¿Ï‚ Ï„Î·Ï‚ Î³Ï�Î±Î¼Î¼Î±Ï„Î¿ÏƒÎµÎ¹Ï�Î¬Ï‚.",

  strings_ja: {
    "slide":"ã‚¹ãƒ©ã‚¤ãƒ‰",
    "help?":"ãƒ˜ãƒ«ãƒ—",
    "contents?":"ç›®æ¬¡",
    "table of contents":"ç›®æ¬¡ã‚’è¡¨ç¤º",
    "Table of Contents":"ç›®æ¬¡",
    "restart presentation":"æœ€åˆ�ã�‹ã‚‰å†�ç”Ÿ",
    "restart?":"æœ€åˆ�ã�‹ã‚‰"
  },
  help_ja:
     "ãƒžã‚¦ã‚¹å·¦ã‚¯ãƒªãƒƒã‚¯ ãƒ» ã‚¹ãƒšãƒ¼ã‚¹ ãƒ» å·¦å�³ã‚­ãƒ¼ " +
     "ã�¾ã�Ÿã�¯ Page Up ãƒ» Page Downã�§æ“�ä½œï¼Œ S ãƒ» Bã�§ãƒ•ã‚©ãƒ³ãƒˆã‚µã‚¤ã‚ºå¤‰æ›´",
  ...
  help_zh:
    "ç”¨é¼ æ ‡ç‚¹å‡», ç©ºæ ¼æ�¡, å·¦å�³ç®­å¤´, Pg Up å’Œ Pg Dn å¯¼èˆª. " +
    "ç”¨ S, B æ”¹å�˜å­—ä½“å¤§å°�.",

  strings_ru: {
    "slide":"Ñ�Ð»Ð°Ð¹Ð´",
    "help?":"Ð¿Ð¾Ð¼Ð¾Ñ‰ÑŒ?",
    "contents?":"Ñ�Ð¾Ð´ÐµÑ€Ð¶Ð°Ð½Ð¸Ðµ?",
    "table of contents":"Ð¾Ð³Ð»Ð°Ð²Ð»ÐµÐ½Ð¸Ðµ",
    "Table of Contents":"ÐžÐ³Ð»Ð°Ð²Ð»ÐµÐ½Ð¸Ðµ",
    "restart presentation":"Ð¿ÐµÑ€ÐµÐ·Ð°Ð¿ÑƒÑ�Ñ‚Ð¸Ñ‚ÑŒ Ð¿Ñ€ÐµÐ·ÐµÐ½Ñ‚Ð°Ñ†Ð¸ÑŽ",
    "restart?":"Ð¿ÐµÑ€ÐµÐ·Ð°Ð¿ÑƒÑ�Ðº?"
  },
  help_ru:
    "ÐŸÐµÑ€ÐµÐ¼ÐµÑ‰Ð°Ð¹Ñ‚ÐµÑ�ÑŒ ÐºÐ»Ð¸ÐºÐ°Ñ� Ð¼Ñ‹ÑˆÐºÐ¾Ð¹, Ð¸Ñ�Ð¿Ð¾Ð»ÑŒÐ·ÑƒÑ� ÐºÐ»Ð°Ð²Ð¸ÑˆÑƒ Ð¿Ñ€Ð¾Ð±ÐµÐ», Ñ�Ñ‚Ñ€ÐµÐ»ÐºÐ¸" +
    "Ð²Ð»ÐµÐ²Ð¾/Ð²Ð¿Ñ€Ð°Ð²Ð¾ Ð¸Ð»Ð¸ Pg Up Ð¸ Pg Dn. ÐšÐ»Ð°Ð²Ð¸ÑˆÐ¸ S Ð¸ B Ð¼ÐµÐ½Ñ�ÑŽÑ‚ Ñ€Ð°Ð·Ð¼ÐµÑ€ ÑˆÑ€Ð¸Ñ„Ñ‚Ð°.",
  ...
  strings_sv: {
    ...
    "Table of Contents":"InnehÃ¥llsfÃ¶rteckning",
    "restart presentation":"visa presentationen frÃ¥n bÃ¶rjan",
    "restart?":"bÃ¶rja om"
  },
  help_sv:
    "BlÃ¤ddra med ett klick med vÃ¤nstra musknappen, mellanslagstangenten, " +
    "vÃ¤nster- och hÃ¶gerpiltangenterna eller tangenterna Pg Up, Pg Dn. " +
    "AnvÃ¤nd tangenterna S och B fÃ¶r att Ã¤ndra textens storlek.",
